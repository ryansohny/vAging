...
# cellchat@DB <- CellChatDB # https://github.com/sqjin/CellChat/issues/96#issuecomment-885818183
cellchat_m01@DB <- CellChatDB
cellchat_m01 <- subsetData(cellchat_m01)
cellchat_m10@DB <- CellChatDB
cellchat_m10 <- subsetData(cellchat_m10)
cellchat_m20@DB <- CellChatDB
...
cellchat_m01 <- identifyOverExpressedGenes(cellchat_m01)
cellchat_m01 <- identifyOverExpressedInteractions(cellchat_m01)

cellchat_m10 <- identifyOverExpressedGenes(cellchat_m10)
cellchat_m10 <- identifyOverExpressedInteractions(cellchat_m10)

cellchat_m20 <- identifyOverExpressedGenes(cellchat_m20)
cellchat_m20 <- identifyOverExpressedInteractions(cellchat_m20)

# project gene expression data onto PPI (Optional: when running it, USER should set `raw.use = FALSE` in the function `computeCommunProb()` in order to use the projected data)
# cellchat <- projectData(cellchat, PPI.human)

cellchat_m01 <- computeCommunProb(cellchat_m01)
cellchat_m10 <- computeCommunProb(cellchat_m10)
cellchat_m20 <- computeCommunProb(cellchat_m20)
