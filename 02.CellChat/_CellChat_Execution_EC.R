...
anndata_object <- anndata$read_h5ad("/data/Projects/phenomata/01.Projects/11.Vascular_Aging/03.Scanpy/CellChat/test3_endo2.h5ad") # scran normalized data matrix input
...
cellchat <- createCellChat(object = data.input, meta = meta, group.by = "EC_sub")
